...
# Section Analyse
    ...
    with col1:
        st.markdown(
            f"""
            <div style="background-color:#f0f8ff;color:#007acc; padding:10px; border-radius:10px; text-align:center">
                <h3>👥 Clients</h3>
    ...
    with col2:
        ...
        st.markdown(
            f"""
            <div style="background-color:#fff0f0;color:#007acc; padding:10px; border-radius:10px; text-align:center">
                <h3>❌ Churn Rate</h3>
    ...
    with col3:
        ...
        st.markdown(
            f"""
            <div style="background-color:#f0fff0;color:#007acc; padding:10px; border-radius:10px; text-align:center">
                <h3>💰 Salaire Moyen</h3>
